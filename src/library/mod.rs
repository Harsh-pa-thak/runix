// Layer 1: Common Library — 70+ ASCII art illustrations compiled into the binary.
...
pub fn list_all() -> Vec<&'static str> {
    vec![
        ...
        // Celestial
        "planet", "earth", "saturn", "star", "ufo", "comet",
        // Objects
        ...
        "robot", "alien", "snowflake", "dna", "helix", "guitar", "music", "note",
        "chess", "pawn", "target", "maze", "compass", "flag",
        // People / Fantasy
